...
import com.ldt.navigation.action.util.CloseProgressDrawable2;
import com.ldt.navigation.action.util.EditTextBoldCursor;
...
public class ActionBarMenuItem extends FrameLayout {
    ...
    public ActionBarMenuItem(Context context, ActionBarMenu menu, int backgroundColor, int iconColor, boolean text) {
        ...
        if (text) {
            ...
            textView.setTypeface(AndroidUtilities.getTypeface(getContext(),"fonts/rmedium.ttf"));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getActionMasked() == MotionEvent.ACTION_DOWN) {
            if (longClickEnabled && hasSubMenu() && (popupWindow == null || popupWindow != null && !popupWindow.isShowing())) {
                ...
                mHandler.postDelayed(showMenuRunnable,200);
    ...
    public TextView addSubItem(int id, CharSequence text) {
       ...
       // textView.setBackgroundDrawable(Theme.getSelectorDrawable(false));
        if (/*!LocaleController.isRTL*/false) {
    ...
    public void toggleSubMenu() {
        ...
        if (showMenuRunnable != null) {
            mHandler.removeCallbacks(showMenuRunnable);
    ...
    public ActionBarMenuItem setIsSearchField(boolean value) {
        ...
        if (value && searchContainer == null) {
            ...
            searchFieldCaption.setTextColor(Color.BLACK);
            ...
            searchField.setCursorColor(Color.BLACK);
            ...
            clearButton.setContentDescription("Clear");//LocaleController.getString("ClearButton", R.string.ClearButton));
