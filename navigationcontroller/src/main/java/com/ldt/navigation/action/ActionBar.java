...
import com.ldt.navigation.action.util.BuildVars;
import com.ldt.navigation.action.util.FireworksEffect;
import com.ldt.navigation.action.util.LayoutHelper;
import com.ldt.navigation.action.util.SnowflakesEffect;
...
public class ActionBar extends FrameLayout {
    ...
    public ActionBarMenu createActionMode(boolean needTop) {
        ...
        actionMode.setBackgroundColor(Color.GRAY);
        ...
        if (occupyStatusBar && needTop && actionModeTop == null) {
            ...
            actionModeTop.setBackgroundColor(Color.WHITE);
    ...
    public void showActionModeTop() {
        if (occupyStatusBar && actionModeTop == null) {
            actionModeTop = new View(getContext());
            actionModeTop.setBackgroundColor(Color.BLUE);
            addView(actionModeTop);
    ...
    public void setTitleOverlayText(String title, int titleId, Runnable action) {
        ...
        CharSequence textToSet = title != null ? title /*LocaleController.getString(title, titleId) */ : lastTitle;
