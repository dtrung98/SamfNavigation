...
import com.ldt.navigation.action.util.AnimationProperties;
...
public class BottomSheet extends Dialog {
    ...
    public BottomSheet(Context context, boolean needFocus, int backgroundType) {
        ...
        shadowDrawable.setColorFilter(new PorterDuffColorFilter(Color.BLUE, PorterDuff.Mode.MULTIPLY));
    ...
    public void show() {
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            ...
            containerView.postDelayed( startAnimationRunnable = new Runnable() {
                @Override
                public void run() {
