...
public class BaseFragment {
 ...
 /*   public int getCurrentAccount() {
    ...
    protected ActionBar createActionBar(Context context) {
        ...
        actionBar.setItemsBackgroundColor(Color.WHITE, false);
        actionBar.setItemsBackgroundColor(Color.WHITE, true);
        actionBar.setItemsColor(Color.BLUE, false);
        actionBar.setItemsColor(Color.BLUE, true);
        if (inPreviewMode) {
            actionBar.setOccupyStatusBar(false);
        }
        return actionBar;
    ...
    protected void onBecomeFullyVisible(Context context) {
