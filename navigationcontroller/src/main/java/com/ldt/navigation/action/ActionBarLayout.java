...
import com.ldt.navigation.action.util.CubicBezierInterpolator;
    ...
    public class LinearLayoutContainer extends LinearLayout {
        ...
        protected void onLayout(boolean changed, int l, int t, int r, int b) {
            ...
            if (waitingForKeyboardCloseRunnable != null && !containerView.isKeyboardVisible && !containerViewBack.isKeyboardVisible) {
                mHandler.removeCallbacks(waitingForKeyboardCloseRunnable);
...
/*    private AnimatorSet themeAnimatorSet;*/
    ...
    private void onSlideAnimationEnd(final boolean backAnimation) {
        if (!backAnimation) {
            ...
            lastFragment.onResume();
            lastFragment.onBecomeFullyVisible(getContext());
        } else {
            if (fragmentsStack.size() >= 2) {
    ...
    private void startLayoutAnimation(final boolean open, final boolean first, final boolean preview) {
        ...
        mHandler.post(animationRunnable = new Runnable() {
            @Override
            public void run() {
    ...
    public void resumeDelayedFragmentAnimation() {
        ...
        mHandler.removeCallbacks(delayedOpenAnimationRunnable);
        ...
        if (needAnimation || preview) {
            if (useAlphaAnimations && fragmentsStack.size() == 1) {
                ...
                onOpenAnimationEndRunnable = () -> {
                    ...
                    fragment.onBecomeFullyVisible(getContext());
                };
                ...
                if (animation == null) {
                    ...
                    if (containerView.isKeyboardVisible || containerViewBack.isKeyboardVisible) {
                        ...
                        mHandler.postDelayed(waitingForKeyboardCloseRunnable,200);
                        ...
                        mHandler.postDelayed(delayedOpenAnimationRunnable,200);
           ...
           /* if (themeAnimatorSet != null) {
            ...
            if (needAnimation) {
                ...
                onCloseAnimationEndRunnable = () -> {
                    ...
                    previousFragmentFinal.onBecomeFullyVisible(getContext());
                };
                AnimatorSet animation = null;
                if (!inPreviewMode && !transitionAnimationPreviewMode) {
                ...
                previousFragment.onBecomeFullyVisible(getContext());
            }
        } else {
