...
/**
 * Show fragment floating in the screen
 * This fragment is maintained by the provided FragmentManager but its view is put under android.R.id.content
 * This Fragment allows you have fragments is child of another fragment but still flat the ui structure
 */
public class PersistentDialogFragment extends Fragment {
    ...
    public ViewGroup onCreateDialogContainerView(@Nullable Bundle savedInstanceState) {
    ...
    public LayoutInflater onGetLayoutInflater(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            mDialogContainerView = onCreateDialogContainerView(savedInstanceState);
        } finally {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        requireActivity().getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                if (mCancelable) {
                    if (getParentFragmentManager().getPrimaryNavigationFragment() == PersistentDialogFragment.this) {
