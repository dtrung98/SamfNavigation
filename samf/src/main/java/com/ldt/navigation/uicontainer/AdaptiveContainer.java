...
public abstract class AdaptiveContainer implements UIContainer {

  private UIContainer mSubContainer;

  public final UIContainer getCurrentContainer() {
    return mSubContainer;
  }

  @NonNull
  protected abstract UIContainer createContainer(Fragment controller, int wQualifier, int hQualifier, float dpUnit);

  @Override
  public void provideQualifier(Fragment controller, int wQualifier, int hQualifier, float dpUnit) {
    mSubContainer = createContainer(controller, wQualifier, hQualifier, dpUnit);
  ...
  public View onCreateLayout(Context context, LayoutInflater inflater, ViewGroup viewGroup, int subContainerId) {
    return getCurrentContainer().onCreateLayout(context, inflater, viewGroup, subContainerId);
  }

  @Override
  public View provideLayout(Context context, LayoutInflater inflater, ViewGroup viewGroup, int subContainerId) {
  return getCurrentContainer().provideLayout(context, inflater, viewGroup, subContainerId);
  }

  @Override
  public void bindLayout(View view) {
    UIContainer subContainer = getCurrentContainer();
